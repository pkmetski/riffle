...
internal object NoopReadaloudLinkRepository : ReadaloudLinkRepository {
    ...
    override suspend fun findByStorytellerBook(storytellerServerId: String, storytellerBookId: String): ReadaloudLink? = null
    override suspend fun findByAbsItem(absServerId: String, absLibraryItemId: String): ReadaloudLink? = null
    override suspend fun unlink(storytellerServerId: String, storytellerBookId: String) = Unit
