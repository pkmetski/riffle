...
class NavigationDrawerViewModelTest {
    ...
    private object CatalogStub : com.riffle.core.catalog.Catalog {
        ...
        override suspend fun <T> withFileStream(itemId: String, format: com.riffle.core.catalog.BookFormat, handleHint: String?, block: suspend (com.riffle.core.catalog.CatalogFileStream) -> T): T = throw UnsupportedOperationException()
