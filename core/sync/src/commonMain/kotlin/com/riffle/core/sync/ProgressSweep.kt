...
class ProgressSweep(
    ...
    suspend fun run() {
        ...
        for (sourceId in sources) {
            ...
            if (source.supportsEbookProgress) for (itemId in ledger.dirtyEbookItems(sourceId)) {
            ...
            if (source.supportsAudiobookProgress) for (itemId in ledger.dirtyAudioItems(sourceId)) {
                if (openTargets.isOpen(sourceId, itemId)) continue
