 ...
 *
 * The "To Read" playlist is deliberately filtered out of every user-facing flow — it has its own
 * dedicated affordance ([ToReadRepository]) and tab. The filter lives in exactly one place
 * ([observePlaylists]); callers never see it.
 */
