 ...
 * reconciliation (ADR 0008 / ADR 0036). Returns `null` (or `0L`) if the source can't report a stamp;
 ...
 * (Storyteller's own record is not a peer, ADR 0035; ABS's audio side rides the same
