...
abstract class RiffleDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        //   - `libraryId` to `local_files_folders` (stable unique ID per existing folder).
        ...
        val MIGRATION_52_53 = object : Migration(52, 53) {
            override fun migrate(db: SQLiteConnection) {
                ...
                try {
                    ...
                    //    ADD COLUMN) because we need a per-row ID that varies across rows.
                    db.execSQL(
                    ...
                    // Collect existing folder rows so we can mint a stable ID per row.
...
expect object RiffleDatabaseConstructor : RoomDatabaseConstructor<RiffleDatabase> {
    override fun initialize(): RiffleDatabase
}
