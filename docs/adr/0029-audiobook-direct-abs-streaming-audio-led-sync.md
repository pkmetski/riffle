...
- **Out of scope for v1** (each a later feature): the persistent now-playing mini-bar, offline audiobook download (v1 is stream-only), chapter-list jump sheet, sleep timer, audiobook bookmarks.
