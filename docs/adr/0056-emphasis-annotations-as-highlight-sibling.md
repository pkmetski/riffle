# ADR 0056 — Emphasis annotations as a Highlight sibling
...
Emphasis anchors on EPUB CFI (ADR 0028), so PDF and CBZ are out of v1 for the same reason Highlights are. Emphasis gets page-anchored form when PDF annotations do.
