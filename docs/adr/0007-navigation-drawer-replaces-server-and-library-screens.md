...
> **Amended by [ADR 0049](0049-source-and-service-abstractions-replace-server.md)** — "Server Switcher" becomes "Source Switcher"; the drawer lists Libraries for the active **Source** of any type (ABS, LocalFiles, …). The drawer shape and rationale are otherwise unchanged.
