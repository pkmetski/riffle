# ADR 0039 — Pre-warm player handoff: keep MediaController alive and pre-fetch session data during drag

**Status:** Accepted
**Relates to:** [ADR 0035](0035-audiobook-direct-abs-streaming-audio-led-sync.md), [ADR 0037](0037-unified-matched-book-position.md).
