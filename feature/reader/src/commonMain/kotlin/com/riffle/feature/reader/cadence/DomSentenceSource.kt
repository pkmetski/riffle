 ...
 *
 * See ADR 0046 (`docs/adr/0046-sentence-playback-pipeline-shared-with-cadence.md`) for the shared
 * [SentenceSource] contract between Readaloud (SMIL) and Cadence (DOM).
 */
